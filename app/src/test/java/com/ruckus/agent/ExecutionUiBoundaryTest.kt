...
class ExecutionUiBoundaryTest {
    @Test
    fun successfulReportPassesThrough() = runBlocking {
    ...
    @Test
    fun recoverableExceptionBecomesFailedReport() = runBlocking {
    ...
    fun coroutineCancellationStillPropagates() = runBlocking {
    ...
    fun fatalErrorStillPropagates() = runBlocking {
        ExecutionUiBoundary.run {
