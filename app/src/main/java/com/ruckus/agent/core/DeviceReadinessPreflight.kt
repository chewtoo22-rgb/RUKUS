 ...
 * unavailable instead of partially executing blind. Permission-gated device writes
 * are also checked across the entire remaining plan so a later step cannot strand a
 * task after earlier side effects have already run.
 */
